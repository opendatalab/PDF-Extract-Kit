...
python batch_deal_with_layout.py --root_path $1 --index_part $2 --num_parts $3 --inner_batch_size 16 --batch_size 16 --num_workers 8 --redo --result_save_path analysis/add_on_metadata/metadata # --accelerated_layout --accelerated_mfd 