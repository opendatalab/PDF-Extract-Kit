...
do
    ...
    nohup  python $scipt_path --root $1 --index_part $TRUEINDICES  --num_parts $CHUNKSIZE --savepath opendata:s3://llm-pdf-text/pdf_gpu_output/scihub_shared/physics_part/ > .log/convert/thread.$TRUEINDICES.log 2>&1 &
    pids[$CPU]=$!
done 
